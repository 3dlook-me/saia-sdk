...
class SAIA {
   ...
   * @param {boolean} options.frontImageEl - front image input element
   * @param {boolean} options.sideImageEl - side image input element
   * @param {boolean} options.genderEl - gender input element
   * @param {boolean} options.heightEl - height input element
   * @param {boolean} options.startButtonEl - height input element
   * @param {boolean} options.resultsEl - results container element
   * @param {boolean} options.statusEl - status element
