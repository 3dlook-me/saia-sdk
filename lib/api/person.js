...
class Person {
   ...
   * @param {boolean} [params.validateImages] - should apply back-end validation
  ...
  create(params) {
    ...
    if (params.validateImages) {
      getParams.validate_images = params.validateImages;
    }
   ...
   *   .catch(err => console.log(err));
   * @param {number} id - Person's ID
   * @param {boolean} hasVirtualTryOn - should process virtual try on
   * @param {any} product - product sku for virtual try on
