...
class Person {
   ...
   * @returns {Promise<string>} person's id or taskset id
   */
  create(params) {
    if (!params) {
    ...
    if (params.gender && params.height) {
      data.gender = params.gender;
      data.height = params.height;
    } else if (params.frontImage && params.sideImage) {
      data.front_image = params.frontImage;
      data.side_image = params.sideImage;
    } else {
      throw new Error('you need to specify gender and height or frontImage and sideImage or either');
    }
